...
export const LandingPage = () => {
  return (
    <div className="bg-gray-950 text-white">
      ...
      <div id="Sobre-Nosotros" className="min-h-screen flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center justify-center w-full p-8 bg-gray-950">
      ...
      <div id="Servicios" className="p-5 min-h-screen">
        <h2 className="text-center md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-blue-800 mb-12">Servicios</h2>
