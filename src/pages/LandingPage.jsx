  ...
  return (
    <div className="bg-gray-950 text-white">
      ...
      <div id="Sobre-Nosotros" className="min-h-screen">
        <h2 className="text-center md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-blue-800 mb-12 ">Sobre Nosotros</h2>

        <div className="justify-center flex flex-wrap p-8 bg-gray-950">
          <div className="bg-gray-900 border border-gray-800 p-8 rounded-lg shadow-lg w-full max-w-2xl mx-auto">
            <h3 className="text-4xl text-center mb-5 text-white">Nuestra Misión</h3>
